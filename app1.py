...
main_prompt = ChatPromptTemplate.from_messages(
    [
        ("system", """
    You are mpoxbot, an AI assistant specialized in answering questions and offering understanding about mpox or monkey pox.
...
final_rag_chain = RunnableWithMessageHistory(
    ...
    # get_session_history  replace the lambda function with this when working local,
...
if input := st.chat_input():
    ...
    st.chat_message("ai").write((operation["answer"]))
